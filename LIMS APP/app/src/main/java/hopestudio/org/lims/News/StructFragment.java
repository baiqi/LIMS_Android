 ...
 */
public class StructFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View ruleView = inflater.inflate(R.layout.fragment_news_struct, container, false);

        // 获取RecyclerView的元素对象
        recyclerView = (RecyclerView) ruleView.findViewById(R.id.news_struct_recyclerView);
