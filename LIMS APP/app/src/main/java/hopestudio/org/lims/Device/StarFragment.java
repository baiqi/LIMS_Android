...
public class StarFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View deviceStarView = inflater.inflate(R.layout.fragment_device_star, container, false);

        // 获取RecyclerView的元素对象
        recyclerView = (RecyclerView) deviceStarView.findViewById(R.id.device_star_recyclerView);
