 ...
 */
public class FunctionFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View departmentView = inflater.inflate(R.layout.fragment_device_total_function, container, false);

        // 获取RecyclerView的元素对象
        recyclerView = (RecyclerView) departmentView.findViewById(R.id.device_total_function_recyclerView);
        ...
        for(int i = 0; i < 10; i++) {
            ...
            deviceCategoryBean.deviceCategoryTitle = "功能" + i;
