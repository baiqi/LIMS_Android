 ...
 */
public class PositionFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View departmentView = inflater.inflate(R.layout.fragment_device_total_position, container, false);

        // 获取RecyclerView的元素对象
        recyclerView = (RecyclerView) departmentView.findViewById(R.id.device_total_position_recyclerView);
        ...
        for(int i = 0; i < 10; i++) {
            ...
            deviceCategoryBean.deviceCategoryTitle = "位置" + i;
