...
public class ServiceFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View ruleView = inflater.inflate(R.layout.fragment_news_service, container, false);

        // 获取RecyclerView的元素对象
        recyclerView = (RecyclerView) ruleView.findViewById(R.id.news_service_recyclerView);
